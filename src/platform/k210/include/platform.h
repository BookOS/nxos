...
#define DRAM_SIZE_DEFAULT (6 * NX_MB)

#define MEM_SBI_BASE    0x80000000UL
#define MEM_SBI_SZ      (128 * NX_KB)

#define MEM_KERNEL_BASE (MEM_SBI_BASE + MEM_SBI_SZ)
#define MEM_KERNEL_SZ   (512 * NX_KB)

#define MEM_NORMAL_BASE (MEM_KERNEL_BASE + MEM_KERNEL_SZ)

#define MEM_MIN_SIZE    (4 * NX_MB)

#define MEM_KERNEL_SPACE_SZ  (6 * NX_MB)

#define MEM_KERNEL_TOP  (MEM_SBI_BASE + MEM_KERNEL_SPACE_SZ)

/* max cpus for qemu */
#define PLATFORM_MAX_NR_MULTI_CORES 2
